  ...
  module Core
    ...
    module ProductFilters
      ...
      def self.price_filter
        ...
        conds = [[I18n.t('spree.under_price', price: format_price(1000)), value[:amount].lteq(1000)],
                 ["#{format_price(1000)} - #{format_price(1500)}", value[:amount].between(1000..1500)],
                 ["#{format_price(1500)} - #{format_price(3000)}", value[:amount].between(1500..3000)],
                 ["#{format_price(3000)} - #{format_price(5000)}", value[:amount].between(3000..5000)],
                 [I18n.t('spree.or_over_price', price: format_price(5000)), value[:amount].gteq(5000)]]
        {
